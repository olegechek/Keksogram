...
const descriptionArray = ['Пробую новый фотик', 'Прелести фотолинз', 'Поймал хороший ракурс',
  'Класс! Моя любимая.', 'Теперь и у меня есть такая фотка', 'Сделал на мобилу', 'Фото без подготовки',
  'Долго парился', 'Недолго парился', 'Лучший кадр дня', 'Хороший цвет', 'Старая коллекция',
  'Заснято на зеркалочку', 'На долгую выдержку', 'Мгновенное фото', 'Случайно получилось',
  'Заморочка с тенями', 'Просто четко', 'Не моя', 'Из чужой коллекции', 'Из новенького',
  'Прошлогодний архив', 'Свежак', 'На штативе', 'Сочненькая)'];

const commentNameArray = ['Петя', 'Коля', 'Лена', 'Гриша', 'Тамара', 'Костя', 'Арчибальд', 'Тарас',
  'Назар', 'Юля', 'Таня', 'Ричард'];

const commentMessageArray = ['Всё отлично!', 'В целом всё неплохо. Но не всё.',
